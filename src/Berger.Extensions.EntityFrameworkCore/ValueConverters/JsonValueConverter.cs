...
public sealed class JsonValueConverter<T>(JsonSerializerOptions? options = null) : ValueConverter<T?, string?>(value => Serialize(value, options), value => Deserialize(value, options))
{
